...
<body>
	...
	<div class="wrap">
		...
		'${member.id }'<c:if test="${status.last eq false}">,</c:if>
					</c:forEach>
					입니다.
				</p>
			</c:if>
			...
			<div class="linkDiv">
				<input class="link" type="button"
					onclick="location.href='findPwForm.do';" value="비밀번호 찾기"> <input
					class="link" type="button" onclick="location.href='loginForm.do';"
					value="로그인">
			</div>
		</div>
	</div>
