...
<style type="text/css">
@import url("${path}/resources/css/joinForm.css");
</style>
...
<script type="text/javascript">
	...
	// 아이디 중복 검사 후 수정하면 확인 결과 지우기 
	function idChk2() {
		document.getElementById("idChk1").innerHTML = "";
	} 
		...
		<div class="joinForm">
			...
			<div class="formDiv">
				<form action="join.do" method="post" name="frm"
					...
					<input class="textBox" type="text" name="id" required="required"
						autofocus="autofocus" onKeyup="idChk2()"> <input
						class="chkBtn" type="button" value="중복확인" onclick="idChk(this)">
					<div class="chkDiv" id="idChk1"></div>
					<p class="p_space">비밀번호</p>
					<input class="textBox" type="password" name="password"
						id="password" required="required" onKeyup="pwChk(this)"
					...
					<input class="textBox" type="password" name="password2"
						required="required" onKeyup="pwChk2()"><br>
					...
					<input class="textBox" type="text" name="nickName"
						required="required" onKeyup="nickNameChk2()"> <input
						class="chkBtn" type="button" value="중복확인" onclick="nickNameChk()">
